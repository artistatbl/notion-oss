  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "relative w-(--sidebar-width) bg-transparent transition-[width,transform] duration-300 ease-in-out",
      ...
      <div
        ...
        className={cn(
          ...
          side === "left"
            ? "left-0 group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1)] group-data-[collapsible=offcanvas]:scale-x-0 group-data-[collapsible=offcanvas]:opacity-0"
            : "right-0 group-data-[collapsible=offcanvas]:right-[calc(var(--sidebar-width)*-1)] group-data-[collapsible=offcanvas]:scale-x-0 group-data-[collapsible=offcanvas]:opacity-0",
      ...
      >
        <div
          ...
          className="bg-sidebar group-data-[variant=floating]:border-sidebar-border flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm transition-all duration-300 ease-in-out group-data-[collapsible=offcanvas]:scale-95"
        >
          {children}
        </div>
      </div>
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <>
      ...
      {showTooltip && (
          <div
            className="fixed z-50 overflow-hidden rounded-md border bg-primary px-3 py-1.5 text-xs text-white  shadow-md animate-in fade-in-0 zoom-in-95 pointer-events-none"
            style={{
...
export { HoverSidebar } from "./hover-sidebar"
